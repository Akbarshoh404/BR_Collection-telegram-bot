...
const ProductCard = ({ product }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-surface rounded-[20px] overflow-hidden shadow-[0_8px_20px_rgba(0,0,0,0.03)] border border-border/50 cursor-pointer relative group flex flex-col h-full"
    >
          ...
          <div className="flex flex-col gap-1.5">
            {hasDiscount && (
              <motion.div 
                ...
                className="bg-error/90 backdrop-blur-sm text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm max-w-fit pointer-events-auto"
              >
                {discountLabel}
              </motion.div>
            )}
